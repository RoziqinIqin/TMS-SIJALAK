...
<script language="javascript">
	function sendValue(s,k,i,m,n,o) {
 	var selvalue=s.value;
 	var selvalue1=k.value;
        var selvalue2=i.value;
        var selvalue3=m.value;
        var selvalue4=n.value;
        var selvalue5=o.value;
	...
	window.opener.document.getElementById('fld_calcvar19').value = selvalue2;
        window.opener.document.getElementById('fld_calcvar19_dsc').value = selvalue3;
        window.opener.document.getElementById('fld_calcvar20').value = selvalue4;
        window.opener.document.getElementById('fld_calcvar20_dsc').value = selvalue5;
        window.close();
	}
...
<input type="hidden" name="fix_cost<?echo $no;?>" id="fix_cost<?echo $no;?>" value="<? echo $rviewrs->fix_cost; ?>">
<input type="hidden" name="fix_cost_dsc<?echo $no;?>" id="fix_cost_dsc<?echo $no;?>" value="<? echo $rviewrs->fix_cost_dsc; ?>">
<input type="hidden" name="daily_fix_cost<?echo $no;?>" id="daily_fix_cost<?echo $no;?>" value="<? echo $rviewrs->daily_fix_cost; ?>">
<input type="hidden" name="daily_fix_cost_dsc<?echo $no;?>" id="daily_fix_cost_dsc<?echo $no;?>" value="<? echo $rviewrs->daily_fix_cost_dsc; ?>">

    <td class="txt2black"><? echo $no ;?></td>
    <td class="txt2black" nowrap><? echo $rviewrs->id; ?></td>
    <td class="txt2black"><? echo $rviewrs->name; ?></td>
    <td align='center'><a href="javascript:void(1)" onclick="sendValue(id<?echo $no;?>,name<?echo $no;?>,fix_cost<?echo $no;?>,fix_cost_dsc<?echo $no;?>,daily_fix_cost<?echo $no;?>,daily_fix_cost_dsc<?echo $no;?>);">>></a></td>
    </tr>
  <?} ?>
<script language="javascript">
if (document.getElementById('ckauto').value == "1") {
   	var selvalue=document.getElementById('id1').value;
        ...
        var selvalue2=document.getElementById('fix_cost1').value;
        var selvalue3=document.getElementById('fix_cost_dsc1').value;
        var selvalue4=document.getElementById('daily_fix_cost1').value;
        var selvalue5=document.getElementById('daily_fix_cost_dsc1').value;
	window.opener.document.getElementById('<?=$ffname?>').value = selvalue;
	window.opener.document.getElementById('<?=$ffname?>' + '_dsc').value = selvalue1;
 	window.opener.document.getElementById('fld_calcvar19').value = selvalue2;
        window.opener.document.getElementById('fld_calcvar19_dsc').value = selvalue3;
        window.opener.document.getElementById('fld_calcvar20').value = selvalue3;
        window.opener.document.getElementById('fld_calcvar20_dsc').value = selvalue4;
        window.close();
	}
</script>
</table>
