<?
	...
	// 	select 
	// 		distinct t0.*, date_format(t1.fld_btdt,'%d-%m-%Y')'date',
	// 		t1.fld_btp24,
	...
	// 		t4.fld_btbalance,
	// 		t0.fld_btnoalt,
	// 		t0.fld_btp01 'fld_route', t0.fld_btp02 'tujuan',
	// 		t0.fld_vehicle,
	...
	$viewrs = $this->db->query("
		select 
			...
			if(t1.fld_baidv=1,t1.fld_btp25,0) 'fld_btp25',
			t2.fld_tyvalnm 'veh_type',
			if(t1.fld_btp02=1,t1.fld_btp06,t3.fld_empnm) 'driver',
			t4.fld_btamt,
			t4.fld_bttax,
			t4.fld_btbalance,
			t0.fld_btno,
			t0.fld_btnoalt,
			t0.fld_btp01 'fld_route', t0.fld_btp02 'tujuan',
			if(t1.fld_btp02=1,t1.fld_btp05,t0.fld_vehicle) 'kendaraan',
			format(t0.fld_btamt01,0) 'amount',
			date_format(tx0.fld_btdt,'%d-%m-%Y')'tx0date',
			format(t0.fld_btamt05,0) 'dp'
		from tbl_trk_billing t0
...
<div class="">
	...
	<table width="100%" class="content">
		...
		<tr>
			<td colspan="4"  class="style1">Jl. Jogja-Solo Km 12,5 Padukuhan Karang Kalasan Tirtomartani Sleman Yogyakarta 55571</td>
		</tr>
		<tr>
		<td></td>
		</tr>
		...
		<tr>
			<td colspan="4" class="style1"><div data-canvas-width="194.48531280808655">
				<div align="center"><strong>REKAPITULASI ANGKUTAN</strong></div>
				</div>
				<div data-canvas-width="307.47506206273977">
				  <div align="center"><strong><?=$data->fld_benm?></strong></div>
				</div></td>
		</tr>
		<tr>
			<td colspan="2" class="style1"><div align="right">Nomor Tagihan : <strong>
				<?=$data->fld_btno?> </strong></div></td>
		</tr>
	</table>
		...
		<tfoot style="border:none">
			...
			<tr>
				...
				<td colspan="2" class="style1"><div align="right"><strong>Total DP </strong></div></td>
					<td class="style1"><div align="right"><strong>
						<?php
						if ($data->fld_btamt == $data->fld_btuamt) {
							echo "0";
						}	
						else {
							echo number_format($data->fld_btuamt,0,',','.');
						}
						?>
					</strong></div></td>
			</tr>
				...
				<td class="style1"><div align="right"><strong>
					<?php
						if ($data->fld_btamt == $data->fld_btuamt) {
							...
							echo number_format($data->amount,0,',','.');
						}
						?>
					</strong></div></td>
			</tr>
