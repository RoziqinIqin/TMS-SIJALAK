...
<fieldset>
<legend><b>Menu Order</b></legend>
<div>
<table align='left'>
  <tr>
      <input type="hidden" name="fld_bttyid" id="fld_bttyid" value="15">
      <input type="hidden" name="fld_baido" id="fld_baido" value="3">
...
<br>
<fieldset>
<legend><b>Menu Item</b>
<div>
<table align='right'>
  <tr>
      <td>Total Harga</td>
      <td>:</td>
      <td align="right"><input type='text' name='fld_btamt_dsc' id='fld_btamt_dsc' class="txtTotal_Price" align="right"><input type='hidden' name='fld_btamt' id='fld_btamt' class="txtTotal_Price" align="right"></td>
  </tr>
</table>
</div>
<br>
...
<td width="100" class="txt2Bold">Code / Name</td>
...
<tr>
    <td><? echo $i; ?></td>
    <input type="hidden" name='39Count' id='39Count' value='15'>
    ...
    <td><input type="text" name='fld_btqty1<? echo $i; ?>' id='fld_btqty1<? echo $i; ?>' size="5" onChange="pos_sub_total(<? echo $i; ?>)"></td>
    <td><input type="text" name='fld_btuamt<? echo $i; ?>' id='fld_btuamt<? echo $i; ?>' size="10" readonly></td>
    <td><input type="text" name='fld_btamt1<? echo $i; ?>' id='fld_btamt1<? echo $i; ?>' size="10"   readonly></td>
</tr>
<?
}
?>
