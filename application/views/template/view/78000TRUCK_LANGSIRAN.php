...
<table cellpadding="1" cellspacing="1" width="100%">
  ...
  <input type='hidden' name='langsir' id='langsir' value='1'>
...
<?
  ...
  $viewrs = $this->db->query("select 
                              tx0.fld_btid 'id',
                              tx0.fld_btp01 'dokumen',
                              1 'type', 
                              tx0.fld_btp04 +  tx0.fld_btp06 'price',
                              t0.fld_btnoalt 'number', t0.fld_btno 'pod_number',
			       ...
			       t7.fld_btiid 'vehicle_id',t7.fld_bticd 'vehicle_no',fld_btbalance,
                              t0.fld_btloc, tx0.fld_btdesc
			      from tbl_btd_langsiran tx0
			      left join  tbl_bth t0 on t0.fld_btid=tx0.fld_btidp
			      ...
			      left join tbl_area t4 on t4.fld_areaid=t3.fld_routefrom
                              ...
                              left join tbl_trk_billing t6 on t6.fld_btreffid=tx0.fld_btid and t6.fld_btflag=2
			      ...
			      t0.fld_btstat = 3
                              and
			      t0.fld_btdt > '2015-06-01 00:00:00'
			      and
...
else
{
    ...
    echo "<td>" .  $rviewrs->customer . "<input type='hidden' name='route$no' id='route$no' value='" . $rviewrs->fld_btdesc . "'></td>";
