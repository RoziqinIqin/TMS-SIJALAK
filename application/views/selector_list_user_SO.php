...
<script language="javascript">
	function sendValue(s,k) {
 	...
 	var selvalue1=k.value;
		var sl1=Math.random();
		var sl2=sl1.toString();
		var sl3=new Date();
		var sl4=sl3.getFullYear()*100+(sl3.getMonth()+1)+"-"+sl2.substring(2,6)+"-"+sl2.substring(7,11)+"-"+sl2.substring(11,15);
	...
	window.opener.document.getElementById('<?=$ffname?>' + '_dsc').value = selvalue1;
        window.opener.document.getElementById('fld_btvou').value = sl4.substring(2,21);
	window.close();
	}
...
<script>
  ...
  window.opener.document.getElementById('<?=$ffname?>' + '_dsc').value = '';
	window.opener.document.getElementById('fld_btvou').value = '';
</script>
<tr >
...
if (document.getElementById('ckauto').value == "1") {
   	...
   	var selvalue=document.getElementById('id1').value;
		...
		var sl2=sl1.toString();
		var sl3=new Date();
		var sl4=sl3.getFullYear()*100+sl3.getMonth()+"-"+sl2.substring(2,6)+"-"+sl2.substring(7,11)+"-"+sl2.substring(11,15);
		window.opener.document.getElementById('<?=$ffname?>').value = selvalue;
	window.opener.document.getElementById('<?=$ffname?>' + '_dsc').value = selvalue1;
        window.opener.document.getElementById('fld_btvou').value = sl4.substring(2,21);
 	window.close();
