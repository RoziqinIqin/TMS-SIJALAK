...
<script language="javascript">
	...
	window.opener.document.getElementById('<?=$ffname?>' + '_dsc').value = selvalue1;
        window.opener.document.getElementById('fld_btuamt').value = selvalue2A;
        window.opener.document.getElementById('fld_btuamt_dsc').value = selvalue2;
	window.close();
	}
...
<input type="hidden" name="BL<?echo $no;?>" id="BL<?echo $no;?>" value="<? echo $rviewrs->BL; ?>">
<input type="hidden" name="fld_btip09<?echo $no;?>" id="fld_btip09<?echo $no;?>" value="<? echo $rviewrs->fld_btip09; ?>">
    ...
    <td align='right' class="txt2black"><? echo $rviewrs->BL; ?></td>
    <td align='center'><a href="javascript:void(1)" onclick="sendValue(id<?echo $no;?>,name<?echo $no;?>,BL<?echo $no;?>,fld_btip09<?echo $no;?>);">>></a></td>
    </tr>
<?} ?>
<script language="javascript">
  ...
  window.opener.document.getElementById('<?=$ffname?>').value = '';
  window.opener.document.getElementById('<?=$ffname?>' + '_dsc').value = '';
	window.opener.document.getElementById('fld_btuamt').value = '0';
	window.opener.document.getElementById('fld_btuamt_dsc').value = '0';
if (document.getElementById('ckauto').value == "1") {
   	var selvalue=document.getElementById('id1').value;
		...
		var selvalue2=document.getElementById('BL1').value;
		var selvalue2A=document.getElementById('fld_btip091').value;
	window.opener.document.getElementById('<?=$ffname?>').value = selvalue;
	window.opener.document.getElementById('<?=$ffname?>' + '_dsc').value = selvalue1;
        window.opener.document.getElementById('fld_btuamt').value = selvalue2A;
        window.opener.document.getElementById('fld_btuamt_dsc').value = selvalue2;
