...
<script language="javascript">
	function sendValue(s,k,l,m,n) {
 	var selvalue=s.value;
 	var selvalue1=k.value;
        var selvalue2=l.value;
	...
	window.opener.document.getElementById('<?=$ffname?>' + '_dsc').value = selvalue1;
        window.opener.document.getElementById('fld_baidc').value = selvalue2;
        window.opener.document.getElementById('fld_baidc_dsc').value = selvalue3;
        window.opener.document.getElementById('fld_btp08').value = selvalue4;
	window.close();
	}
...
<script>
  ...
  window.opener.document.getElementById('fld_baidc').value = '';
  window.opener.document.getElementById('fld_baidc_dsc').value = '';
  window.opener.document.getElementById('fld_btp08').value = '';
</script>
<tr >
...
<input type="hidden" name="fld_beid<?echo $no;?>" id="fld_beid<?echo $no;?>" value="<? echo $rviewrs->fld_beid; ?>">
<input type="hidden" name="fld_benm<?echo $no;?>" id="fld_benm<?echo $no;?>" value="<? echo $rviewrs->fld_benm; ?>">
<input type="hidden" name="fld_btcmt<?echo $no;?>" id="fld_btcmt<?echo $no;?>" value="<? echo $rviewrs->fld_btcmt; ?>">
    <td class="txt2black"><? echo $no ;?></td>
    <td class="txt2black"><? echo $rviewrs->id; ?></td>
    <td class="txt2black"><? echo $rviewrs->name; ?></td>
    <td align='center'><a href="javascript:void(1)" onclick="sendValue(id<?echo $no;?>,name<?echo $no;?>,fld_beid<?echo $no;?>,fld_benm<?echo $no;?>,fld_btcmt<?echo $no;?>);">>></a></td>
    </tr>
  <?} ?>
<script language="javascript">
  window.opener.document.getElementById('<?=$ffname?>').value = '';
